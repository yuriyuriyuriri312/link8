    ...
    methods: {
        ...
        open_dialog(){
            ...
            $(".dialog").fadeIn(800,function(){
                //显示对话信息
                $('.dialog h4').text("你好，来自远方的朋友，欢迎来到睿格,让Reg Book14或艾雪8成为您的生产力吧；还是说您想用炫猎7提升游戏体验呢？");
                $('.dialog h4').css({width:0}).animate({width:1300},17000,function(){
                    $("#select").fadeIn(2000)
                    //动画回到默认
        ...
        openMsg(shop){
            ...
            if(shop=='a')
            {
                ...
                $("#select").hide();
                //显示对话信息
                $('.dialog h4').text("让超薄超轻的Reg book14或性价比超高的艾雪8使你的工作变轻松吧；还是说您想用炫猎7提升游戏体验呢？不管怎样睿格都是您最佳的选择。");
                $('.dialog h4').css({width:0,height:100}).animate({width:2000},23000,function(){
                    $('.dialog h4').css({height:60})
                    $("#select").fadeIn(2000)
                    //动画回到默认
                    that.person="img/gif/idle.gif";
                });
            ...
            }else if(shop=='b')
            {
                ...
                $("#select").hide();
                //显示对话信息
                $('.dialog h4').text("嗯嗯，见到你真开心，下次也一定要来找我玩哟。");
